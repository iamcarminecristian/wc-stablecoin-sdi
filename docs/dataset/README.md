...
| `2026-09-02-v2-approve` | 6 creati, 4 pagati | 12 | Modalita' `approve` (approve e pay per ordine), interrotta al secondo lotto: un pagamento su tre falliva con `ERC20InsufficientAllowance` perche' il nodo che simulava il pagamento non aveva ancora visto l'autorizzazione appena confermata (incoerenza fra i nodi dietro l'endpoint pubblico). I due ordini non pagati scadono dopo un'ora. Il caso e' riportato nel Capitolo 6 come errore del percorso del cliente. |
| `2026-09-02-v2-approve-b` | 15 | 12 | Ripetizione della modalita' `approve` con lo script che attende la visibilita' dell'autorizzazione prima di pagare: misura di riferimento del gas per il cliente occasionale. |
