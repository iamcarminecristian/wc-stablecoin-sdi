...
| `2026-09-02-v2-permit`, `2026-09-02-v2-approve` | 15 ciascuna | 12 | Stesso paniere ridotto in modalita' `permit` (payWithPermit con firma EIP-2612) e `approve` (approve e pay per ordine): gas del cliente occasionale, nel file `gas-<campagna>.csv`. |
