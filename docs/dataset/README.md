...
| `finalita-<rete>-2026-09-02-campioni.csv` | `tools/finalita-l2.mjs --grezzo` | Campioni grezzi ogni 30 secondi per 48 ore: testa, ritardo di `safe` e `finalized` in blocchi e secondi. |
